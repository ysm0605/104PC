...
public class editInventory extends JFrame implements ActionListener{
...
public void actionPerformed(ActionEvent e) {
	...
	if(obj==btn1) {
		...
		int [] b = new int[2];
			...
			String sql = "UPDATE menu SET name ='"+a[1]+"', PRICE ='"+b[0]+"',sold ='"+0+"', quantity ='"+b[1]+"' WHERE name ='"+Inventory.co+"'";
			String aaaa = Inventory.co;
